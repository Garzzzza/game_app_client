...
export default function Wordle({
  ...
  return (
    <div>
      ...
      <div>
        If a letter in your guess is somewhere in the word but not in the right
        place, it'll light up yellow.
      </div>
      <div>
        But when you guess both the right letter and its correct position, it’ll
        be green.
      </div>
      {showMessage && (
        <Message
      ...
      {showButton && <button>Let's play!</button>}
